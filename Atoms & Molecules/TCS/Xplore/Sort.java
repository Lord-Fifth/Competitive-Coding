...
It will return array of books which is sorted in the ascending order of book price. Assume that no two books will have the same 
price.
...
public class Sort {
    public static void main(String args[] ) throws Exception {
        ...
        for(int i = 0; i < 4; i++) {
            System.out.println(b[i].getId() + " " + b[i].getTitle() + " " + b[i].getAuthor() + " " + (int)b[i].getPrice());
        }
